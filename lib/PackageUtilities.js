  ...
  _createClass(PackageUtilities, null, [{
    ...
    value: function getPackages(packagesPath) {
      ...
      _FileSystemUtilities2.default.readdirSync(packagesPath).forEach(function (packageDirectory) {
        ...
        var pkg = PackageUtilities.getPackage(packagePath, packageConfigPath);
    ...
    key: "getPackage",
    value: function getPackage(packagePath, packageConfigPath) {
      var packageJson = require(packageConfigPath);
      return new _Package2.default(packageJson, packagePath);
    }
  }, {
    key: "getPackageGraph",
